...
//      appBar: _buildBar(context),
  ...
  Widget _signInText(BuildContext context) {
    return new Container(
        ...
        child: new Column(children: <Widget>[
          Text("Reset Password", style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.w200), textAlign: TextAlign.left)]));
  }
  ...
  Widget _message(BuildContext context) {
    return new Container(
        padding: EdgeInsets.only(top: 20, bottom:20),
        child: new Column(children: <Widget>[
          Text("Enter your email address below and we'll send you password reset instructions", textAlign: TextAlign.left)]));
  }

                          ...
                          onLongPressEnd: (details) {
                            if (model.deletes.indexOf(todos[index]) == -1) {
                              ...
                              if (model.deletes.length == 1) {
                                model.removeDeletes(
                                    model.deletes.indexOf(todos[index]));
                                model.setSelect();
                              } else {
                                model.removeDeletes(
                                    model.deletes.indexOf(todos[index]));
                            ...
                            if (model.select) {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => AddTodo(
                                        stitle: todos[index].title,
                                        sdate: todos[index].date,
                                        stime: todos[index].time,
                                        scontent: todos[index].content,
                                        scategory: todos[index].category,
                                        stodo: todos[index],
                                      )));
                            }
                          },
                          child: Card(
                            ...
                            child: Container(
                              padding: EdgeInsets.only(
                                  top: 20, left: 25, right: 20, bottom: 5),
                              child: Row(
                                mainAxisAlignment:
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    children: <Widget>[
                                      !todos[index].uploaded ||
                                              todos[index].shouldUpdate
                                          ? Container(

...
import 'package:team_mobileforce_gong/services/notifications/notifications.dart';
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Container(
                        child: Text(
                            widget.stitle != null ? 'Edit Todo' : 'New Todo',
                              ...
                              Provider.of<TodoProvider>(context,
                                  ...
                                  .updateTodo(
                                      ...
                                      _stime ??
                                          TimeOfDay(
                                              hour: int.parse(
                                                  widget.sdate.split(":")[0]),
                                              minute: int.parse(widget.sdate
                                                  .split(":")[1])),
                                      widget.stodo);
                              Navigator.pop(context);
                            }
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          initialValue:
                              widget.stitle == null ? null : widget.stitle,
                      ...
                      Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            value: model.value,
                            items: model.drop.map<DropdownMenuItem<String>>(
                                (String value) {

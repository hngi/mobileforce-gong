...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _signInText(BuildContext context) {
    return new Container(
        ...
        child:
          Text("Sign In", style: TextStyle(fontSize: 30.0, fontFamily: "Gilroy")));
  }
    ...
    return InkWell(
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              'Forgot your password? Reset it ', style: TextStyle(fontFamily: "Gilroy")
            ),
            new GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, "ResetPag");
              },
              child: new Text("here", style: TextStyle(color: Colors.blue, fontFamily: "Gilroy", decoration: TextDecoration.underline)
              )
            ),
          ],
        ),
          ...
          children: <Widget>[
            new Container(
              ...
              child: new RaisedButton(
                  ...
                  child: new Text('LOG IN', style: TextStyle(color: Colors.white, fontFamily: "Gilroy", fontWeight: FontWeight.bold)), color: Colors.blue, onPressed: signupPressed),
            ),
          ],
        )
    );
    ...
    return InkWell(
      child: Container(
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            new Text('Don\'t have an account? ', style: TextStyle(fontFamily: "Gilroy")),
            Container(
              child: GestureDetector(
                onTap: () {
                  ...
                  child:
                  new Text('Sign Up', style: TextStyle(color: Colors.blue, fontFamily: "Gilroy", decoration: TextDecoration.underline))
              )
            )
          ]
        ),

  ...
  Widget _signInText(BuildContext context) {
    return new Container(
        ...
        child: new Column(children: <Widget>[
          Text("Sign Up", style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.w200), textAlign: TextAlign.left)]));
  }
  ...
  Widget _loginButton() {
    return new Container(
      child: new Column(
        children: <Widget>[
          new RaisedButton(
            child: new Text('SIGN UP', style: TextStyle(color: Colors.white)), color: Colors.blue,
          )
        ],
      ),
    );
      ...
      child: new Row(
        children: <Widget>[
          ...
          new FlatButton(
              ...
              child: new Text('Sign In', style: TextStyle(color: Colors.blue)), onPressed: _toLogin)
        ],
      ),
    );
  }

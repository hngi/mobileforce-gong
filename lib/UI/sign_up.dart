...
class SignUpPag extends StatefulWidget {
  SignUpPag({Key key, this.title}) : super(key: key);
...
class _SignUpPagState extends State<SignUpPag> {
  ...
  Widget _signInText(BuildContext context) {
    return new Container(
        ...
        child:
        Text("Sign Up", style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.w200)));
  }
          ...
          children: <Widget>[
            new Container(
              ...
              child: new RaisedButton(
                  ...
                  child: new Text('SIGN UP', style: TextStyle(color: Colors.white)), color: Colors.blue, onPressed: signupPressed),
            ),
          ],
        )
    );
